...
app.post('/api/rc/webhook', async (req, res) => {
  ...
  // Event mapping + idempotency/ordering + TRANSFER handling live in the
  // unit-tested ./lib/rc-webhook.js. We supply the service-role client and this
  // deployment's environment.
  const r = await applyRcEvent(req.body && req.body.event, supabase, RC_WEBHOOK_ENVIRONMENT);
