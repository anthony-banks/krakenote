-- Surface top-of-funnel visits (landing_view) so the admin dashboard shows a
-- clear Visits → Sign-ups view, plus visits per day for the daily chart.
...
as $$
  ...
  select jsonb_build_object(
    ...
    'visits', (select count(*) from ev where name = 'landing_view'),
    ...
    'daily', (
      ...
      from (
        select created_at::date as day,
          count(*)                                            as total,
          count(*) filter (where name = 'landing_view')      as visits,
